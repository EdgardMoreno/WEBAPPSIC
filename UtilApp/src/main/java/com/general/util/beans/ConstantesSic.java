...
//    public static Integer CONS_GENERO_FEMENINO = 2;
    ...
    /*CODIGOS DE CONFIGURACION VI_SICVERSUDM*/
    public static String CONS_COD_VERSUDM_URLPWA   = "COD_URLPWA";
    
    /*CODIGO DE TIPO DE IDENTIFICADORES*/
    public static String CONS_COD_TIPODOCU            = "VI_SICTIPODOCU";
        /*CODIGOS*/
        public static String CONS_COD_TIPODOCU_REQUISITO   = "REQUISITO";
        public static String CONS_COD_TIPODOCU_GENERADOR   = "GENERADOR";
    ...
    public static String CONS_COD_TIPOROLPERS       = "VI_SICTROLPERS";
        ...
        public static String CONS_COD_TROLADMINISTRADO   = "VI_SICADMI";        
    ...
    public static String CONS_COD_ESTA              = "VI_SICESTA";
        ...
        public static String CONS_COD_ESTAENTRAMITE        = "VI_SICESTATRAM";
        public static String CONS_COD_ESTARESUELTO         = "VI_SICESTARESU";
