 ...
 */
package com.general.util.security;
...
public class EncryptUtils implements Serializable{
    ...
    private static final String strEncriptkey = "M1NC92A3E6A73TUR";
    private static final String strEncriptVector =  "*123@45/78%Z91=&";
    ...
    public static String encrypt(String cleartext) throws Exception {
            ...
            SecretKeySpec skeySpec = new SecretKeySpec(strEncriptkey.getBytes(), alg);
            IvParameterSpec ivParameterSpec = new IvParameterSpec(strEncriptVector.getBytes());
