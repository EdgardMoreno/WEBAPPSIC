...
/**********************************************************************************/
function fnShowPopup(desUrlPWA, idEvento, idStipodocu, idDocu, desTitulo, idPersAdmi) {

        console.log("desUrlPWA:" + desUrlPWA);
        console.log("idEvento:" + idEvento);
        console.log("idStipodocu:" + idStipodocu);
        console.log("idDocu:" + idDocu);
        console.log("idPersAdmi:" + idPersAdmi);

        //Se sobreescribe la propiedad HREF
        $("#linkDialog").attr("href",desUrlPWA + "/administrado/tupa/frmRequisito.aspx?IdEvento=" + idEvento + "&IdTipoDocu=" + idStipodocu + "&IdDocu=" + idDocu + "&titulo=" + desTitulo + "&vista=1&idUsuario=" + idPersAdmi + "&flgbpm=1&tipoFrm=N&tipoRol=1");
        $("#linkDialog").click(); //Origina que llame a la función de FancyBOX y que muestre la URL especificada.
