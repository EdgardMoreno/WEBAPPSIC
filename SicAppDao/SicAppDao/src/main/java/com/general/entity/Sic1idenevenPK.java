 ...
 */
@Embeddable
public class Sic1idenevenPK implements Serializable {
    ...
    public Sic1idenevenPK() {
    }

    public Sic1idenevenPK(BigInteger idTipoiden, String codIden) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Sic1idenevenPK)) {
            return false;
        }
        Sic1idenevenPK other = (Sic1idenevenPK) object;
    ...
    public String toString() {
        return "com.general.entity.Sic1idenevenPK[ idTipoiden=" + idTipoiden + ", codIden=" + codIden + " ]";
    }
